...
# Local UI bootstrap policy (S01)
BOOTSTRAP_REQUIRED_COMPONENTS = ("serial_manager", "image_processor")
BOOTSTRAP_READINESS_TIMEOUT_SECONDS = 2.0
BOOTSTRAP_RENDER_TIMEOUT_SECONDS = 4.0
BOOTSTRAP_PUBLISH_TIMEOUT_SECONDS = 8.0
