...
### Display
ESP32 was setted as the intermediate point for driving the waveshare 4.2 e-paper display. Due to the specific design of our spherical robot, the display would be rendered in 180 clock-wise rotated.